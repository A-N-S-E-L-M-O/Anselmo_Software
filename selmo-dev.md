...
*Updated session 27 · 2026-06-21 · v0.902*
...
**Future module:** `selmo-settings.js` — the tray-in-browser panel (LLM switch, image-model pick, srv/chunking edit, unload/reload/exit) — will be a new module talking to the extended control API on port 8087, so the tray's interactive parts become reachable from any remote browser without growing `chat.html`. Its startup wiring goes in `selmo-boot.js`.
